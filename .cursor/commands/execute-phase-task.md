# /execute-phase-task — Execute a specific task from the active phase

Act as the **Phase Executor** (see `/phase-executor`).
...
3. **Re-read** the global CoreMind rule to refresh conventions.
